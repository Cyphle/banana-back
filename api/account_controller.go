...
type AccountHttpHandler struct {
	Logger     *slog.Logger
	Repository domain.Repository[account.Account]
}

func NewAccountHttpHandler(logger *slog.Logger, repository domain.Repository[account.Account]) *AccountHttpHandler {
